...
We found that $\lesssim5\%$ of the simulations, in which the core size was larger than 200 pc, both SMBHs were detected. 
...
We conclude that only under very rare conditions, and with very long observations ($>40$ hours), central image may allow us to probe binary SMBHs. The prospects of such measurement will ultimately depend on discoveries of much larger samples of lenses \citep{}. 
