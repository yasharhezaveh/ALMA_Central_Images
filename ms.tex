...
In contrast to lensed quasars, the sources are extended over hundreds of parsecs and suffer a range of demagnifications.
 This can allow them to overlap with the less demagnified regions of the source plane, further increasing the flux of the central images \citep[analogous to magnification damping of highly magnified images due to finite source effects, see e.g.,][]{hezaveh:11}.
...
\begin{center}
\centering
\includegraphics[trim= 10 0 0 0, clip, width=0.48\textwidth]{f_02.eps}
\centering
\end{center}
...
\begin{center}
\centering
\includegraphics[trim= 0 0 5 6, clip, width=0.48\textwidth]{f_01.eps}
\centering
\end{center}
\vspace{-1mm}
...
The black hole was modeled as a simple point mass at the center of the potential. We assumed that all the three components are concentric, \red{though we note that two- and three-black hole interactions may may invalidate this assumption.}
...
\begin{center}
\centering
\includegraphics[trim= 0 0 0 0, clip,width=0.48\textwidth]{f_03.eps}
\centering
\end{center}
...
The fluxes of central images depend principally on the slope of the lensing potential, the core size, and the mass of the central SMBHs.  Figure \ref{fig:3} shows the detection significance of a central image for a range of these parameters in a 10-h long ALMA observation. 
...
As the source galaxies are undergoing prodigious star formation, these large source sizes are reasonable and in agreement with observations \cite{hezaveh:13b}.
More extended and intrinsically brighter emission lines such as C[II], the brightest molecular line in high redshift galaxies, are therefore the most ideal targets for such observations.% \red{which lines are optimal as a function of zs?}

\begin{figure}
\begin{center}
\centering
\includegraphics[trim= 2 5 0 0, clip, width=0.48\textwidth]{f_04.eps}
\centering
\end{center}
...
\begin{center}
\centering
\includegraphics[trim= 20 0 20 0, width=0.46\textwidth]{f_05.eps}
\centering
\end{center}
...
\red{In principle, several black holes could be held up in ??? orbits in these young massive galaxies.}
